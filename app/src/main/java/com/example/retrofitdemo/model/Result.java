...
public class Result extends BaseObservable implements Parcelable
{
    ...
    @ColumnInfo(name = "check_favorite")
    private boolean favoriteCheckBox;

    @Bindable
    public boolean isFavoriteCheckBox() {
        return favoriteCheckBox;
    }

    public void setFavoriteCheckBox(boolean favoriteCheckBox) {
        this.favoriteCheckBox = favoriteCheckBox;
        notifyPropertyChanged(BR.favoriteCheckBox);
    }
    ...
    public static void loadImage(ImageView imageView, String PathUrl){
        Glide.with(imageView.getContext()).load(PathUrl)
